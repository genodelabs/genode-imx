...
#define TSK_STACK_CANARY 1360 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2816 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_KEYS_USER 3784 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3864 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_GCR_EL1_USER 3888 /* offsetof(struct task_struct, thread.gcr_user_excl) */
...
#define TRAMP_VALIAS -8627699712 /* TRAMP_VALIAS */
