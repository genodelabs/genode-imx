...
MIRROR_FROM_PORT_DIR := $(addprefix linux/,$(shell cat $(REP_DIR)/src/drivers/usb_host/imx8mq/source.list)) \
                        $(addprefix linux/,$(shell cat $(REP_DIR)/src/drivers/usb_host/imx8mq/deps.list))
...
MIRROR_FROM_REP_DIR  := src/drivers/usb_host/imx8mq \
                        src/include/imx8mq \
                        src/lib/imx8mq
