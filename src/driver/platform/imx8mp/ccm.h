...
struct Driver::Ccm
{
	...
	class Frac_pll1443: public Clock
	{
		...
		public:
			...
			void _disable() override { _mmio.disable();  }
	};
	...
	/* Target Root interface implementation for root clocks */
	...
	class Root_clock_divider : public Clock, Mmio<0x4>
	{
		...
		public:
			...
			Root_clock_divider(Clocks               &clocks,
			                   ...
			                   Byte_range_ptr const &range,
			                   Clock                &parent)
			: Clock { clocks, name }, Mmio { range }, _parent(parent) {}
	...
	Frac_pll1443 dram_pll_clk   { clocks, "dram_pll_clk",   frac_pll_range(0x50), verbose };
	...
	Frac_pll1416 arm_pll_clk    { clocks, "arm_pll_clk",    frac_pll_range(0x84), verbose };

	Frac_pll1416 system_pll1_clk { clocks, "system_pll1_clk", frac_pll_range(0x94),  verbose };
	Frac_pll1416 system_pll2_clk { clocks, "system_pll2_clk", frac_pll_range(0x104), verbose };
	...
	Root_clock media_isp_clk_root            { clocks, "media_isp_clk_root",
	                                           ...
	                                           audio_pll2_clk, ext_clk_1, system_pll2_div2 };
	Root_clock main_axi_clk_root             { clocks, "main_axi_clk_root",
	                                           ...
	                                           audio_pll1_clk, video_pll_clk, system_pll1_div8 };
	...
	Root_clock media_apb_clk_root           { clocks, "media_apb_clk_root",
	                                           ...
	                                           system_pll3_clk, system_pll1_div20,
	                                           audio_pll2_clk, ext_clk_1, system_pll1_div6 };
	...
	Root_clock dram_alt_clk_root             { clocks, "dram_alt_clk_root",
	                                           ...
	                                           system_pll3_clk, audio_pll1_clk, system_pll1_div3 };
	...
	Root_clock memrepair_clk_root            { clocks, "memrepair_clk_root",
	                                           ...
	                                           video_pll_clk, audio_pll2_clk, system_pll1_div6 };
	...
	Root_clock nand_clk_root                 { clocks, "nand_clk_root",
	                                           ...
	                                           system_pll3_clk, system_pll2_div4, video_pll_clk };
	...
	Root_clock gic_clk_root                  { clocks, "gic_clk_root",
	                                           ...
	                                           system_pll2_div2, ext_clk_4, audio_pll2_clk };
	...
	Root_clock pwm1_clk_root                 { clocks, "pwm1_clk_root",
	                                           ...
	                                           ext_clk_1, system_pll1_div10, video_pll_clk };
	...
	Root_clock pwm3_clk_root                 { clocks, "pwm3_clk_root",
	                                           ...
	                                           system_pll2_div10, system_pll1_div5,
	                                           system_pll1_div20, system_pll3_clk,
	                                           ext_clk_2, system_pll1_div10, video_pll_clk };
	...
	Root_clock ipp_do_clko2                  { clocks, "ipp_do_clko2",
	                                           ...
	                                           audio_pll1_clk, video_pll_clk, k32_ref_clk };
	...
	Root_clock hdmi_ref_266m_clk_root        { clocks, "hdmi_ref_266m_clk_root",
	                                           ...
	                                           system_pll2_div5, audio_pll1_clk, video_pll_clk };
	...
	Gate debug_gate       { clocks, "debug_gate",     gate_range(4),   ahb_clk_root };
	Gate dram1_gate       { clocks, "dram1_gate",     gate_range(5),   dram_alt_clk_root };
	...
	Gate gpio1_gate       { clocks, "gpio1_gate",     gate_range(11),  ipg_clk_root };
	Gate gpio2_gate       { clocks, "gpio2_gate",     gate_range(12),  ipg_clk_root };
	Gate gpio3_gate       { clocks, "gpio3_gate",     gate_range(13),  ipg_clk_root };
	Gate gpio4_gate       { clocks, "gpio4_gate",     gate_range(14),  ipg_clk_root };
	Gate gpio5_gate       { clocks, "gpio5_gate",     gate_range(15),  ipg_clk_root };
	Gate gpt1_gate        { clocks, "gpt1_gate",      gate_range(16),  gpt1_clk_root };
	Gate gpt2_gate        { clocks, "gpt2_gate",      gate_range(17),  gpt2_clk_root };
	Gate gpt3_gate        { clocks, "gpt3_gate",      gate_range(18),  gpt3_clk_root };
	Gate gpt4_gate        { clocks, "gpt4_gate",      gate_range(19),  gpt4_clk_root };
	Gate gpt5_gate        { clocks, "gpt5_gate",      gate_range(20),  gpt5_clk_root };
	Gate gpt6_gate        { clocks, "gpt6_gate",      gate_range(21),  gpt6_clk_root };
	...
	Gate iomux_gate       { clocks, "iomux_gate",     gate_range(27),  ipg_clk_root };
	Gate ipmux1_gate      { clocks, "ipmux1_gate",    gate_range(28),  ahb_clk_root };
	Gate ipmux2_gate      { clocks, "ipmux2_gate",    gate_range(29),  ahb_clk_root };
	Gate ipmux3_gate      { clocks, "ipmux3_gate",    gate_range(30),  ahb_clk_root };
	Gate mu_gate          { clocks, "mu_gate",        gate_range(33),  ipg_clk_root };
	Gate ocotp_gate       { clocks, "ocotp_gate",     gate_range(34),  ipg_clk_root };
	Gate ocram_gate       { clocks, "ocram_gate",     gate_range(35),  main_axi_clk_root };
	Gate ocram_s_gate     { clocks, "ocram_s_gate",   gate_range(36),  ahb_clk_root };
	Gate pcie_gate        { clocks, "pcie_gate",      gate_range(37),  pcie_aux_clk_root };
	...
	Gate qos_enet_gate    { clocks, "qos_enet_gate",  gate_range(46),  enet_qos_clk_root };
	Gate flexspi_gate     { clocks, "flexspi_gate",   gate_range(47),  ahb_clk_root };
	Gate rawnand_gate     { clocks, "rawnand_gate",   gate_range(48),  nand_clk_root };
	Gate rdc_gate         { clocks, "rdc_gate",       gate_range(49),  ipg_clk_root };
	Gate i2c5_gate        { clocks, "i2c5_gate",      gate_range(51),  i2c5_clk_root };
	Gate i2c6_gate        { clocks, "i2c6_gate",      gate_range(52),  i2c6_clk_root };
	Gate can1_gate        { clocks, "can1_gate",      gate_range(53),  can1_clk_root };
	Gate can2_gate        { clocks, "can2_gate",      gate_range(54),  can2_clk_root };
	Gate sctr_gate        { clocks, "sctr_gate",      gate_range(57),  ipg_clk_root };
	Gate sdma1_gate       { clocks, "sdma1_gate",     gate_range(58),  ipg_clk_root };
	Gate enet_qos_gate    { clocks, "enet_qos_gate",  gate_range(59),  enet_axi_clk_root };
	Gate sema1_gate       { clocks, "sema1_gate",     gate_range(61),  ipg_clk_root };
	Gate sema2_gate       { clocks, "sema2_gate",     gate_range(62),  ipg_clk_root };
	Gate irq_steer_gate   { clocks, "irq_steer_gate", gate_range(63),  ipg_clk_root };
	Gate gpu2d_gate       { clocks, "gpu2d_gate",     gate_range(69),  gpu2d_clk_root };
	Gate gpu3d_gate       { clocks, "gpu3d_gate",     gate_range(70),  gpu_axi_clk_root };
	Gate snvs_gate        { clocks, "snvs_gate",      gate_range(71),  ipg_clk_root };
	Gate trace_gate       { clocks, "trace_gate",     gate_range(72),  trace_clk_root };
	...
	Gate usb_gate         { clocks, "usb_gate",       gate_range(77),  hsio_axi_clk_root };
	...
	Gate vpu_g1_gate      { clocks, "vpu_g1_gate",    gate_range(86),  vpu_g1_clk_root };
	Gate gpu_gate         { clocks, "gpu_gate",       gate_range(87),  gpu_ahb_clk_root };
	Gate vpu_vc8ke_gate   { clocks, "vpu_vc8ke_gate", gate_range(89),  vpu_vc8000e_clk_root};
	Gate vpu_g2_gate      { clocks, "vpu_g2_gate",    gate_range(90),  vpu_g2_clk_root };
	Gate npu_gate         { clocks, "npu_gate",       gate_range(91),  ml_ahb_clk_root };
	Gate hsio_gate        { clocks, "hsio_gate",      gate_range(92),  hsio_axi_clk_root };
	Gate media_gate       { clocks, "media_gate",     gate_range(93),  media_mipi_phy1_ref_clk_root};
	Gate usdhc3_gate      { clocks, "usdhc3_gate",    gate_range(94),  usdhc3_clk_root };
	Gate hdmi_gate        { clocks, "hdmi_gate",      gate_range(95),  hdmi_apb_clk_root };
	Gate vpu_gate         { clocks, "vpu_gate",       gate_range(99),  vpu_bus_clk_root};
	Gate mrpr_gate        { clocks, "mrpr_gate",      gate_range(100), ipg_clk_root };
	Gate audio_gate       { clocks, "audio_gate",     gate_range(101), audio_ahb_clk_root };
};
